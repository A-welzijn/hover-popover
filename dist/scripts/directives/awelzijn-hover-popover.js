...
(function (module) {
    try {
        module = angular.module('awelzijn.hoverpopover');
    } catch (e) {
        module = angular.module('awelzijn.hoverpopover', []);
    }
    module.directive('aWelzijnHoverPopover', ['$q', '$templateCache', '$http', '$compile', '$timeout', '$window', '$rootScope', function ($q, $templateCache, $http, $compile, $timeout, $window, $rootScope) {
        return {
            restrict: 'EA',
            scope: true,
                        ...
                        function show() {
                            if (theTemplate !== null) {
                                theTemplate.then(function (data) {
                                    scope.$parent.ctrl[attrs.hoverPopoverOpen]()
                                    if (isOpen === null) {
